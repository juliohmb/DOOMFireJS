        ...
        for (let i = 0; i < fireHeight; i++){
            ...
            for(let j = 0; j < fireWidth; j++){
                ...
                if (debug === true){
                    ...
                    context.fillStyle = `rgb(${fireColorsPalette[firePixelsArray[index]].r},${fireColorsPalette[firePixelsArray[index]].g},${fireColorsPalette[firePixelsArray[index]].b})`
